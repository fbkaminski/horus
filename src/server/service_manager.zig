...
const Platform = server_file.Platform;
const ServiceHandle = server_file.ServiceHandle;
const ServiceId = server_file.ServiceId;
const CapToken = server_file.CapToken;
const InterfaceId = server_file.InterfaceId;
...
const IpcChannel = channel_file.IpcChannel;
const IpcServerChannel = channel_file.IpcServerChannel;
